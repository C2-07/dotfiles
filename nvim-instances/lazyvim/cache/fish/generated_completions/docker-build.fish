# docker-build
# Autogenerated from man page /opt/homebrew/share/man/man1/docker-build.1
...
complete -c docker-build -l add-host -d '   Add a custom host-to-IP mapping (host=ip, or host:ip) Add a line to /etc/h…'
...
complete -c docker-build -s c -l cpu-shares -d '  CPU shares (relative weight)'
