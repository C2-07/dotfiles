...
complete -c brew -l global -d 'Read from or write to the Brewfile from $HOMEBREW_BUNDLE_FILE_GLOBAL (if set)…'
...
complete -c brew -l whalebrew -d 'list or dump Whalebrew dependencies'
...
complete -c brew -l install-on-request -d 'Output the number of specifically requested installations of the formula'
complete -c brew -l build-error -d 'Output the number of build errors for the formulae'
complete -c brew -l os-version -d 'Output OS versions'
complete -c brew -l homebrew-devcmdrun-developer -d 'Output devcmdrun/HOMEBREW_DEVELOPER'
complete -c brew -l homebrew-os-arch-ci -d 'Output OS/Architecture/CI'
...
complete -c brew -l ignore-errors -d 'Record all discovered resources, even those that can[u2019]t be resolved succ…'
