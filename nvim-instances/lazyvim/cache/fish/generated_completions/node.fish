...
complete -c node -l experimental-quic -d 'Enable the experimental QUIC support'
...
complete -c node -l test-global-setup -d 'Specifies a module containing global setup and teardown functions for the tes…'
